                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Data Table Produccts</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
                    ...
                    <a href="{{ route('admin.products.create') }}" class="btn btn-primary btn-sm">
                        <i class="fadeIn animated bx bx-plus"></i> Create
                    </a>
                </div>
            </div>
            <!--end breadcrumb-->
            <h6 class="mb-0 text-uppercase">Table Products</h6>
            <hr/>
            <div class="card">
                <div class="card-body">
