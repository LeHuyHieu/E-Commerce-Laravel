                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="text-muted font-size-sm">{{ $data_user['address'] }}</p>
                                        </div>
                                    </div>
                                    <hr class="my-4" />
                            ...
                            <div class="card">
                                <form  method="post" action="{{ route('admin.update.profile') }}" class="card-body" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="phone" class="form-control" value="{{ $data_user['phone'] }}" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="address" class="form-control" value="{{ $data_user['address'] }}" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
